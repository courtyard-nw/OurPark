...
<body>
	<header>
		<div class="header">
			<div id="header_bg"
				style="background: url(resources/img/header_background_darker.png) no-repeat;"></div>
			...
			<a href="#" id="user"> <img src="resources/img/user.png"
				id="defaultImg" class="t" alt="회원메뉴 버튼"> <c:if
					test="${sessionScope.img != null}">
					<img
						src="upload/${sessionScope.img.uuid}_${sessionScope.img.filename}"
						id="userImg" class="userImg" alt="회원사진">
				</c:if>
			</a>
			<h3 class="header_txt">
			...
			<div id="header_input">
				<form action="map/map" method="get">
					...
					<input type="text" placeholder="동네 이름, 궁금한 장소를 입력하세요"
						name="keyword">
		...
		<div class="main">
			...
			<div id="container">
				<a href="map/map?keyword=노은동 어린이공원">
					<div
						style="background: url(resources/img/playground.png) no-repeat;">
						<h3>
							혼자 있기 좋은<br>
							<span>놀이터</span>
						</h3>
					</div>
				</a> <a href="map/map?keyword=은구비 공원">
					<div style="background: url(resources/img/park.png) no-repeat;">
						<h3>
							나무가 울창한<br>
							<span>공원</span>
						</h3>
					</div> <!-- <img src="resources/img/park.JPG">
                    <h3>나무가 울창한<br>공원</h3>  -->
				</a> <a href="map/map?keyword=대전수목원">
					...
					<form method="post" action="login">
						<div class="form-floating mb-3">
							<input type="text" class="form-control rounded-4"
								id="floatingInput" name="id" placeholder="name@example.com">
							<label for="floatingInput">아이디</label>
						</div>
						<div class="form-floating mb-3">
							<input type="password" class="form-control rounded-4"
								id="floatingPassword" name="passwd" placeholder="Password">
						...
						<hr class="my-4">
						<a href="signup"
							class="w-100 py-2 mb-2 btn btn-outline-dark rounded-4"> 회원가입
						</a>
					</form>
				</div>
			</div>
