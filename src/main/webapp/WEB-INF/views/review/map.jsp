    ...
    <header>
        <div class="header">
            ...
            <c:if test="${sessionScope.member != null}">
               	<a href="addAddr" id="review">리뷰 쓰기</a>
			</c:if>
            <a href="#" id="user">
...
<script src="//dapi.kakao.com/v2/maps/sdk.js?appkey=8796d82dc62ffc9f32f62a077be64357&libraries=services,clusterer,drawing"></script>
